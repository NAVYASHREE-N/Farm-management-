...
def edit(rid):
    ...
    if request.method == "POST":
        ...
        # `adharnumber`='{adharnumber}',`age`='{age}',
        # `gender`='{gender}',`phonenumber`='{phonenumber}',
        # `address`='{address}',`farming`='{farmingtype}'")
        post = Register.query.filter_by(rid=rid).first()
...
def register():
    ...
    if request.method == "POST":
        ...
        address = request.form.get('address')
        farmingtype = request.form.get('farmingtype')
        query = Register(farmername=farmername, adharnumber=adharnumber,
                         age=age,
                         gender=gender,
        ...
        # (`farmername`,`adharnumber`,`age`,
        # `gender`,`phonenumber`,`address`,`farming`)
        # VALUES ('{farmername}','{adharnumber}','{age}'
        # ,'{gender}','{phonenumber}','{address}','{farmingtype}')")
